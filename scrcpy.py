...
def connect_via_usb():
    input(f"""
{Fore.WHITE}[{Fore.MAGENTA}*{Fore.WHITE}] {Fore.BLUE}Following Tracks About {Fore.GREEN}[{Fore.YELLOW}USB{Fore.GREEN}] {Style.RESET_ALL}
+----+-------------------+
...
def main():
    ...
    if choice == "1":
        ...
        input(f"""
{Fore.WHITE}[{Fore.MAGENTA}*{Fore.WHITE}] {Fore.BLUE}Following Tracks About {Fore.GREEN}[{Fore.YELLOW}IP/TCP{Fore.GREEN}] {Style.RESET_ALL}
+----+--------------------+
| {Fore.MAGENTA}ID{Style.RESET_ALL} | {Fore.GREEN}Tracking{Style.RESET_ALL}           |
+----+--------------------+
| {Fore.BLUE}1{Style.RESET_ALL}  | {Fore.YELLOW}Settings{Style.RESET_ALL}           |
